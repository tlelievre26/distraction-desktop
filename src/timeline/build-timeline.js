...
const { getCompletedTasks } = require("../task_list/components/TaskContext");
...
const calcMetrics = (data, sessionId) => {
  ...
  const sessionMetrics = {
    ...
    numTasks: getCompletedTasks(), // Number of tasks completed
    tabSwitchRate: 0, // # of times tabs were switched divided by number of minutes in session
