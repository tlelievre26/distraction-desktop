  ...
  useEffect(() => {
    ...
    ipcRenderer.on('return-prev-sessions', (_event, sessionMetadata) => {
      ...
      const prevSessions = sessionMetadata.map((prevSession) => ({
        name: formatDate(prevSession.startTime, prevSession.endTime), sessionId: prevSession.QuerySession, duration: prevSession.duration, startTime: prevSession.startTime, endTime: prevSession.endTime
      }));
